        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Auto = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderServiceMappings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrderServiceMappings_CompanyServices_CompanyServiceId",
                        column: x => x.CompanyServiceId,
                        principalTable: "CompanyServices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderServiceMappings_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderServiceMappings_CompanyServiceId",
                table: "OrderServiceMappings",
                column: "CompanyServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderServiceMappings_OrderId",
                table: "OrderServiceMappings",
                column: "OrderId");
        }
